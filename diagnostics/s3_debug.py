    ...
    try:
        ...
        async with s3_factory() as s3_client:
            ...
            try:
                ...
                print(f"  ✅ Object stored, ETag: {put_response.get('ETag', 'unknown')}")
                ...
                if "NoSuchBucket" in str(e) or "403" in str(e):
                    ...
                    print(f"     Try creating bucket '{bucket}' or set ARTIFACT_BUCKET env var")
                else:
...
async def test_s3_provider_with_custom_endpoint():
    ...
    try:
        ...
        async with s3_factory() as s3_client:
            ...
            # Test bucket access
            await s3_client.head_bucket(Bucket=bucket)
            print(f"  ✅ Custom endpoint bucket access successful")
