    ...
    try:
        ...
        try:
            ...
            if len(found_files) == 0:
                ...
                print(
                    f"      Searching entire temp directory: {len(all_matches)} matches"
                )
        ...
        try:
            ...
            try:
                copy_id = await store.copy_file(
                    doc_id, new_filename="docs/test_copy.md"
                )
    ...
    try:
        ...
        try:
            ...
            if bucket_dir.exists():
                ...
                non_meta_files = [
                    f for f in all_files if not f.name.endswith(".meta.json")
                ]
...
async def run_integration_tests():
    ...
    if failed == 0:
        print(
            "🎉 All integration tests passed! Filesystem provider works with ArtifactStore."
        )
        return True
    else:
