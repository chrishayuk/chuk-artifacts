...
from chuk_artifacts.providers.filesystem import factory, create_temp_filesystem_factory, cleanup_filesystem_store
...
async def test_basic_filesystem_operations():
    ...
    try:
        ...
        async with factory_func() as client:
            ...
            # Test head_object
            head_response = await client.head_object(Bucket="test-bucket", Key="test-file.txt")
            ...
            print(f"  ✅ list_objects_v2 successful: found {list_response['KeyCount']} objects")
